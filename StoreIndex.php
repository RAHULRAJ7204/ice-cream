...
<body>
		  ...
		  <div style=" background:#ff66cc;" class="header">
          
            <img style="position: static;padding: 10px; margin-top:3px;" src="image/ice-cream.png"">
        
              
                <h3 style="margin-top: 10px;font-family:fantasy; margin-top:-241px;font-family: fantasy;padding: 15px;margin-left: 69px;color:white;line-height:346px;margin: -227;font-size: 40px;">Garden Master</h3>
              <!-- </div > -->
            <?php
