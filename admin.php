...
<body>
<div id="admin">
<p> <a style="ReD: white;font-family: monospace;margin-left:4px;font-size: 50px;" href="index.php">REAL ICECREAM ADMIN</a>	</p>
</div>
<?php
...
<div id="section1">
		...
		echo "<br>";
		echo "<h1 style='font-size:20px; text-align:center;font-family:monospace'>REGISTRATION TABLE</h1>";
		echo "<tr>";
		...
		echo "<table>";
		echo "<h1 style='font-size:20px; text-align:center;'>MY SERVICE </h1>";
		echo "<tr>";
			echo "<td>TID</td>";
			echo "<td>CID</td>";
			echo "<td>NAME</td>";
			...
			echo "<tr>";
				...
				echo "<td>				
					<select name='servic' value='".$row4["SERVICE"]."'required='TRUE'>
					  <option value='---'>---</option>
					  <option value='Garden Care' >Franchise Oppartunities</option>
					  <option value='Lawn Moving' >Super Market</option>
					  <option value='Rubbish Removal' >IceCream service</option>
					  <option value='Landscape Design' >General Retail</option>
		...
		echo "<table>";
		echo "<h1 style='font-size:20px; text-align:center;'>IceCream store</h1>";
		echo "<tr>";
			echo "<td>IID</td>";
			echo "<td>INAME</td>";
			echo "<td>IMAGE</td>";
	...
	echo "<br>";
	$qry_select_con = "SELECT * FROM ordertable";
	
	$res2 = mysqli_query($con,$qry_select_con);
	echo "<h1 style='font-size:20px; text-align:center;'>Payment </h1>";
	echo "<table>";
	echo "<tr>";
		echo "<td>ODID</td>";
		echo "<td>CID</td>";
	...
	while($row2 = mysqli_fetch_array($res2))
	{
		...
		echo "<td>".$row2['Payment']."</td>";	
				echo "<td ><a href='admin.php?ODID=$ODID' id='link2'>DELETE</a></td>";
	...
	if(isset($_GET["ODID"]))
			{		
				$ODID = $_GET['ODID'];		
				$qrydel = "DELETE FROM ordertable WHERE ODID = '$ODID'";	
				if($con->query($qrydel))
				{
					echo "<script>alert('PAYMENT details removed');</script>";
					header("location:admin.php");
				}
				else
				{
